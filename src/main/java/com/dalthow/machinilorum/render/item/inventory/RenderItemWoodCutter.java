 ...
 * @Class RenderItemWoodCutter.java
 * 
 **/
...
public class RenderItemWoodCutter implements IItemRenderer
{
	// Declaration
    ...
    public RenderItemWoodCutter()
    {
    	model = AdvancedModelLoader.loadModel(new ResourceLocation(Reference.modId, "models/wood cutter.obj"));
    }
